        <form method="post" enctype="multipart/form-data" action="<?php echo base_url();?>index.php/obat/edit/<?php echo $detil->id_obat?>">
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                <?php
                            ...
                            <div class="row">
                                <div class="col-lg-10">
                                    <form role="form">
                                        ...
                                        <div class="form-group">
                                            <label>Harga</label>
                                            <input type="text" name="harga" class="form-control" placeholder="Enter text" value="<?php echo $detil->harga?>">
                                        </div>
